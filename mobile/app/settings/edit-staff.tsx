...
import { Text, TextInput, Button, HelperText, ActivityIndicator, IconButton } from 'react-native-paper';
      ...
      >
        ...
        >
          <View style={[styles.header, { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }]}> 
            ...
            <Text variant="headlineSmall" style={[styles.headerTitle, { color: '#FFFFFF' }]}>Edit Staff Member</Text>
